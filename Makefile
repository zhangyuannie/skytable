...
_RUN_DEBUG_SKYD += target/${TARGET}/debug/skyd
_CARGO_BUILD_DEBUG_SKYD += --target ${TARGET}
CARGO_TEST += --target ${TARGET}
else
_RUN_DEBUG_SKYD += target/debug/skyd
...
RUN_DEBUG_SKYD += $(CONST_WINDOWS_START_BACKGROUND)
RUN_DEBUG_SKYD += $(_RUN_DEBUG_SKYD)
RUN_DEBUG_SKYD += .exe $(CONST_SKYD_NOART)
...
RUN_DEBUG_SKYD += $(_RUN_DEBUG_SKYD)
RUN_DEBUG_SKYD += $(CONST_SKYD_NOART)
RUN_DEBUG_SKYD += $(CONST_UNIX_START_BACKGROUND)
# add the rm command
